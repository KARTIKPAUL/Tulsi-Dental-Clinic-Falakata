          ...
          <div className="w-full max-w-lg mx-auto">
            <div className="relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                <svg
                  className="w-5 h-5 text-gray-400 transition-colors duration-200 group-focus-within:text-blue-500"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <input
                id="search"
                type="text"
                className="block w-full h-12 pl-12 pr-4 text-lg rounded-xl shadow-sm 
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-4">
                {/* <kbd className="px-2 py-1 text-sm font-semibold text-gray-400 bg-gray-50 rounded-lg">
                  ⌘ /
                </kbd> */}
              </div>
            </div>
                    ...
                    <React.Fragment key={opd._id}>
                      ...
                      {expandedTiles[opd._id] && (
                        <tr>
                          <td
                            colSpan="6"
                            className="px-4 pb-4 bg-gray-50 border border-gray-300"
                          >
                            <motion.div
                            ...
                            >
                              <h2 className="text-3xl font-extrabold text-blue-700 mb-6 flex justify-center items-center gap-2">
                                <ClipboardList
                                  size={28}
