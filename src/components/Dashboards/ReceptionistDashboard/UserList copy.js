...
import { User, Phone, Heart, ClipboardList, X } from "lucide-react";
...
const UsersList = () => {
  ...
  const [isModalOpenChiefComplain, setIsModalOpenChiefComplain] =
    useState(false);
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Show loading toast
      let loadingToastId = toast.loading("OPD Creating...", {
        position: "top-center",
        theme: "colored",
      });
      ...
      // First dismiss the loading toast completely
      ...
      // Then show a separate success toast that won't be affected by the modal closing
    } catch (error) {
      console.error(error);
      const errorMessage =
        error.response?.data?.message || "Failed to create OPD.";
                            ...
                            >
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div className="p-6 border rounded-xl bg-blue-50 shadow-lg hover:shadow-xl transition-all border-blue-300">
                                  ...
                                  <p>
                                    ...
                                    {selectedUser.userDetails?.gender || "N/A"}
                                  </p>
                                  <p>
                                    <strong>DOB:</strong>{" "}
                                  ...
                                  <p>
                                    ...
                                    {selectedUser.userDetails?.contact
                                      ?.mobile || "N/A"}
                                  </p>
                                  <p>
                                ...
                                <div className="p-6 border rounded-xl bg-green-50 shadow-lg hover:shadow-xl transition-all border-green-300">
                                  ...
                                  <p>
                                    ...
                                    {selectedUser.medicalDetails?.bloodGroup ||
                                      "N/A"}
                                  </p>
                                  <p>
                                    <strong>Medical History:</strong>{" "}
                                    {Array.isArray(
                                      selectedUser.medicalDetails
                                        ?.medicalHistory
                                    )
                                ...
                                <div className="p-6 border rounded-xl bg-purple-50 shadow-lg hover:shadow-xl transition-all border-purple-300">
                                  ...
                                  {selectedUser?.opdForms &&
                                  selectedUser.opdForms.length > 0 ? (
                              ...
                              <div className="flex justify-center space-x-4 mt-8">
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    openAppointmentModal(selectedUser)
                                  }
                                >
                                  Create Appointment
                                </button>
